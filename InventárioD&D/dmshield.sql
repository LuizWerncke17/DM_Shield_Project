...
(6, 'Início', 'Lembrete', 'Amanda e Manu estarão indo para Phandalin, pois escutaram sobre o novo restaurante que vai inaugurar logo e querem estar lá para ver a festa, no caminho, em um cruzamento triplo, irão encontrar a Lívia em dúvida de para onde ir, já que a placa está quebrada, vão ajudar ela e ir juntas. Um coelho preto de olhos vermelhos vai pular na frente delas, e aí é com elas. Chegando em Phandalin elas estarão soltas, mas devem ir ver o Kael no bar. Lipe vai estar fazendo um show no bar, e João estará na plateia, na frente do palco bebendo, elas podem falar com Kael, mas quando chegar no drop da música do Lipe irei interromper e fazer a cena foda. Depois da música um valentão chamado Carlos vai chamar eles para um desafio de bebidas. (Vai ter um cara em uma mesa no fundão observando eles).\n\nPagar 20 PO pra participar. \nLembrando que podem sair a qualquer momento. \n1° turno: bebem sem nada de mais\n2° turno: Constituição CD 8\n3° turno: Constituição CD 12\n4° turno: ConstituiçãoCD 16\nE por aí vai. \nSe falhar na salvaguarda do quarto turno algo aleatório acontecerá a noite, e a pessoa n saberá de nada, aos demais, irei perguntar oq eles fazem depois do evento, as pessoas que chegarem no quarto turno acordam com um ponto de exaustão e dor de cabeça como ressaca.'),
(7, 'Tour', 'Evento', 'Depois de eles afugentarem o velho teddy dos estábulos, no dia seguinte ao evento de bebidas, o prefeito agradece eles com 20 PO pra cada, e leva eles para um Tour por Phandalin, aí blz, tenho que pegar a foto e ir apresentando os lugares.   \nQuando eles chegarem na praça dnv um grupo de aspirantes rivais pode comentar sobre Amanda ser filha da Audra, e o prefeito não sabia, então pode falar que é fã da mãe dela e perguntar se pode vê-la.\n\nO chefe do restaurante que não tem identidade ainda pode ver que eles são capazes e pedir ajuda para eles para coletar alguns ingredientes, entregando um mapa de onde coletar cada um, o que me dá um enchimento perfeito de sessão'),
